    ...
    implements MotorController, Sendable, AutoCloseable
{
  ...
  public SwerveModule(DriveMotorType mainMotor, AngleMotorType angleMotor, AbsoluteEncoderType encoder,
                      SwerveModuleLocation swervePosition, double gearRatio, double steeringOffset, double wheelDiameter, double driveTrainWidth, double wheelBase) throws Exception
  {
